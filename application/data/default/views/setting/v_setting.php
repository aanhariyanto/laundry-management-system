<form class="form-horizontal az-form" id="form" name="form" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-7">
                <textarea rows="4" class="form-control ckeditor" name="app_preface" id="app_preface"><?php echo $app_preface;?></textarea>
            </div>
        </div>
        <div class="form-group">
            <label for="" class="col-sm-2 control-label"><?php echo azlang('Invoice Note');?> *</label>
            <div class="col-sm-7">
                <textarea rows="4" class="form-control ckeditor" name="app_invoice" id="app_invoice"><?php echo $app_invoice;?></textarea>
            </div>
        </div>
        <div class="form-group">
