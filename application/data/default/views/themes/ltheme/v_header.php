            ...
            <div class="az-ltheme-header">
                ...
                <div class="az-header-toolbar">
                    <div class="container-language">
                        ...
                        ?>
                        <div class="az-language-list">
                        <a href="<?php echo $url;?>">
                        <button class="btn btn-primary az-btn-primary <?php echo $value['active'];?>" title="<?php echo azlang($value['name']);?>">
                        <?php echo strtoupper($value['code']);?>
                        </button>
                        </a>
                        </div>
                        <?php
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="az-breadcrumb">
                                    <!--<span class="title">Naureens Laundry</span> <i class="fa fa-chevron-right"></i> Sub judul <i class="fa fa-chevron-right"></i> sub judul lagi-->
